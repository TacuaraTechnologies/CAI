...
class  API {
    ...
    func request( parameters: [String : AnyObject]?, completion:(json: JSON?,error: String?) -> Void) {
       ...
       let request = Alamofire.request(.POST, "http://indert.gov.py/segdoc/index.php?o=secciones&seccion=audiencias&accionRPC=app", parameters: parameters, encoding: .JSON).responseSwiftyJSONRenamed { request,response,json,error in
